...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.89-kirby-problem-4.89-281d8570-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.89"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.89-kirby-problem-4.89-281d8570-v1",
      "problem_contract_sha256": "5e247e2b41871e25bfe7f0f72ba16f4b11c3f4059685c9a49b08f167891e0196",
      "problem_id": "problem:um-kp-4.89-kirby-problem-4.89-281d8570",
      "route_id": "route:um-kp-4.89-kirby-problem-4.89-281d8570-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.89-kirby-problem-4.89-281d8570-source-fidelity-01",
      "graph_id": "graph:um-kp-4.89-kirby-problem-4.89-281d8570-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.89-kirby-problem-4.89-281d8570-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.89-kirby-problem-4.89-281d8570-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Classify smooth, effective circle actions on simply connected 4-manifolds with boundary. (a) Classify simply connected4-manifolds with boundary that admit circle actions. (b) For each such 4-manifold, classify the circle actions up to conjugation by diffeomorphisms. (c) Given a 4-manifold X with a circle action on its boundary, when does the action extend over X? When does it extend uniquely?"
          },
          "statement_sha256": "408842ddcdd1caeee4524b625de2deaaa599654cf4d0dfe103593a3fcbd156d4"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.89-kirby-problem-4.89-281d8570-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.89-kirby-problem-4.89-281d8570-root",
      "route_id": "route:um-kp-4.89-kirby-problem-4.89-281d8570-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.89-600910b23bee",
        "url": "https://www.unsolvedmath.com/problems/KP-4.89"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
